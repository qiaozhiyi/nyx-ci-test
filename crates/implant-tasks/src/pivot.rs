...
static CHANNELS: nyx_implant_core::cell::SyncCell<[Option<Channel>; MAX_CHANNELS]> =
    nyx_implant_core::cell::SyncCell::new([None; MAX_CHANNELS]);
...
fn do_connect_prepare(proto: u8, chan: u32) -> Option<Response> {
    if proto != 0 {
        return Some(Response::Err({
            ...
            nyx_implant_core::fmt::push_decimal_u32(&mut e, proto as u32);
